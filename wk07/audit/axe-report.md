...
**Status**: **CONFIRMED** - Path to image does not exist therefore no image is displayed - Add to backlog as low severity
...
## Actions
1. **Low priority (Issue 1)**: Ensure path to image exists and add alternative text if required. Add to backlog
2. **High priority (Issue 2)**: Fix contrast ration for button. Add to backlog
