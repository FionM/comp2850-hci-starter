...
### 1. How long to do the task (Efficiency)
**Definition**: Seconds from the start of the task until it is successfully completed
**How to collect**: Manual timer 
**Analysis**: Mean, median, outliers per task

**Why it matters**: If it takes a long time means they could be finding it difficult

---

### 2. Task Success Rate (Effectiveness)
**Definition**: Percentage of participants who complete task without help
**How to collect**: 1 = success, 0 = failed / uncompleted
**Analysis**: Success % per task, can identify issues
...
**How to collect**: Manual tally during observation 
...
### 4. Mode Comparison - HTMX or No-JS
